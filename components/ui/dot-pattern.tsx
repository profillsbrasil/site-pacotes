...
export function DotPattern({
  ...
  // Função determinística para gerar valores pseudoaleatórios baseados nas coordenadas
  ...
  const dots = useMemo(() => {
    return Array.from(
      ...
      (_, i) => {
        ...
        const random1 = deterministicRandom(x, y);
        const random2 = deterministicRandom(y, x);
        return {
          x,
          y,
          delay: random1 * 5,
          duration: random2 * 3 + 2,
        };
      }
    );
